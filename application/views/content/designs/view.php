...
<div id="product_detail" class="main">
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="2"><?=$design->description_en?></td>
        </tr>
        <tr>
            <td><h3>Picture</h3></td>
...
<?else :?>
<div id="product_detail" class="main">
    <h1 class="title">Rincian Desain <?=$design->name?></h1>
    <div class="links">
        <ul>
    ...
    <table>
        <tr>
            <td><h3>Dibuat oleh</h3></td>
            <td colspan="2"><?=html::anchor('user/view/' . ORM::factory('user' , $design->user_id)->id , ORM::factory('user' , $design->user_id)->first_name . " " . ORM::factory('user' , $design->user_id)->last_name)?></td>
        </tr>
        <tr>
            <td><h3>Nama Desain</h3></td>
            <td colspan="2"><?=$design->name?></td>
        </tr>
        <tr>
            <td><h3>Deskripsi</h3></td>
            <td colspan="2"><?=$design->description?></td>
        </tr>
        <tr>
            <td><h3>Gambar</h3></td>
            <td colspan="2"><img src="<?=$fileurl[1]?>" width="300px" alt="" /></td>
